...
Usage::
    ...
    .venv/bin/python -m friendy_chachkalica.ml.onnx_export.cli runs/foo/best.pt
    .venv/bin/python friendy_chachkalica/ml/onnx_export/cli.py runs/foo/best.pt -o out/foo.onnx
...
try:
    ...
    from ml.onnx_export.registry import get_exporter  # type: ignore
    from ml.trt_export.arch import (  # type: ignore
        get_fp16_node_block,
        get_fp16_op_block,
        is_fp16_trusted,
    )
    from ml.trt_export.fp16_cast import cast_onnx_bytes_to_fp16  # type: ignore
