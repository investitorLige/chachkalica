...
from friendy_chachkalica.ml.adapters.fasterrcnn import FasterRCNNAdapter
from friendy_chachkalica.ml.adapters.retinanet import RetinaNetAdapter
from friendy_chachkalica.ml.train import _predict_with_config
